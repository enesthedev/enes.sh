...
export type GetPublicationQuery = { __typename?: 'Query', publication?: { __typename?: 'Publication', title: string, about?: { __typename?: 'Content', text: string } | null } | null };
 ...
 * });
 */
export function useGetPublicationQuery(baseOptions: Apollo.QueryHookOptions<GetPublicationQuery, GetPublicationQueryVariables> & ({ variables: GetPublicationQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPublicationQuery, GetPublicationQueryVariables>(GetPublicationDocument, options);
      }
export function useGetPublicationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPublicationQuery, GetPublicationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPublicationQuery, GetPublicationQueryVariables>(GetPublicationDocument, options);
        }
export function useGetPublicationSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPublicationQuery, GetPublicationQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPublicationQuery, GetPublicationQueryVariables>(GetPublicationDocument, options);
        }
...
export type GetPublicationSuspenseQueryHookResult = ReturnType<typeof useGetPublicationSuspenseQuery>;
export type GetPublicationQueryResult = Apollo.QueryResult<GetPublicationQuery, GetPublicationQueryVariables>;